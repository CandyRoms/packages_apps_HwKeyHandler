...
public class HardkeyActionHandler implements HardwareKeyHandler {
...
//        }
    ...
    @Override
    public boolean handleKeyEvent(WindowManager.LayoutParams attrs, int keyCode, int repeatCount, boolean down,
            boolean canceled,
